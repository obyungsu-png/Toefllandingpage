...
export function SpeakingQ5Record({ onNext, onHome, onVolumeClick, isVolumeOpen, volumeButtonRef, imageUrl, questionText, responseDelay, stopDuration, duration, isReviewMode = false}: SpeakingQ5RecordProps) {
