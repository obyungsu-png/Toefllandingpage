...
export function ListeningM2Q8({ onBack, onNext, onHome, onVolumeClick, imageUrl }: ListeningM2Q8Props) {
      ...
      <div className="flex-1 p-4 md:p-8 overflow-auto bg-white border border-black pb-20 md:pb-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="md:hidden flex flex-col items-center">
            <ImageWithFallback 
              src={imageUrl || "figma:asset/8f3abde1d39d1dd9b86cfc86cc08354d61a04b50.png"} 
