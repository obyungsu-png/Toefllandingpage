...
interface WritingBuildSentenceQ2Props {
  onBack: () => void;
  onNext: () => void;
  onHome: () => void;
  onVolumeClick?: () => void;
...
export function WritingBuildSentenceQ2({ 
  onBack, 
  onNext, 
  onHome, 
  onVolumeClick,
  avatar1ImageUrl,
  avatar2ImageUrl,
  questionText = 'Are you considering a change?',
  words
}: WritingBuildSentenceQ2Props) {
  const defaultWords = ['a different department', 'if', 'moving to', 'know', 'do', 'you'];
