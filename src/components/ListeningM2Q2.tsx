...
export function ListeningM2Q2({ onBack, onNext, onHome, onVolumeClick, imageUrl, audioUrl }: ListeningM2Q2Props) {
      ...
      <div className="flex-1 p-4 md:p-8 overflow-auto bg-white border border-black pb-20 md:pb-8">
        <div className="w-full">
          ...
          <div className="md:hidden flex flex-col items-center">
            <ImageWithFallback 
              src={imageUrl || "figma:asset/c34029af9a04f96b0e53d6c821e6957a3fac4ad7.png"} 
