...
export function ListeningM2Q4({ onBack, onNext, onHome, onVolumeClick, imageUrl, audioUrl, options, questionText }: ListeningM2Q4Props) {
      ...
      <div className="flex-1 p-4 md:p-8 overflow-auto bg-white border border-black pb-20 md:pb-8">
        <div className="w-full">
          ...
          <div className="md:hidden flex flex-col items-center">
            <ImageWithFallback 
              src={imageUrl || "listening-images/man-burgundy-turtleneck.png"} 
              alt="Woman in green polo shirt"
              ...
              <div className="flex justify-center mb-8">
                ...
                >
                  ...
                  <span>{isPlaying ? 'Playing...' : 'Play Audio'}</span>
                        ...
                        <h2 className="text-3xl font-['Inter',_sans-serif] font-bold text-gray-800 mb-8 text-center">{questionText || "Choose the best response."}</h2>
