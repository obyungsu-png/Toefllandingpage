...
export function SpeakingQ3Record({ onNext, onHome, imageUrl, questionText, responseDelay, stopDuration, duration, isReviewMode = false, existingRecordingUrl }: SpeakingQ3RecordProps) {
    ...
    <div className="fixed inset-0 bg-gray-50 z-50 flex flex-col">
      ...
      <div className="flex items-center gap-2 bg-white border-b border-gray-200 px-3 py-2.5 shadow-sm">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-500 leading-tight">Question 3 of 11</p>
        </div>
