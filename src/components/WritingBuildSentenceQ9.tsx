...
export function WritingBuildSentenceQ9({ 
  onBack, 
  onNext, 
  onHome, 
  onVolumeClick,
  avatar1ImageUrl,
  avatar2ImageUrl,
  questionText = 'How was the training session?',
  words
}: WritingBuildSentenceQ9Props) {
  const defaultWords = ['helpful', 'very', 'it', 'was', 'and', 'practical'];
