...
interface WritingBuildSentenceQ9Props {
  onBack: () => void;
  onNext: () => void;
  onHome: () => void;
  onVolumeClick?: () => void;
...
export function WritingBuildSentenceQ9({ onBack, onNext, onHome, onVolumeClick }: WritingBuildSentenceQ9Props) {
  const [sentenceSlots, setSentenceSlots] = useState<(string | null)[]>([null, null, null, null, null, null, null]);
