...
interface WritingBuildSentenceQ6Props {
  onBack: () => void;
  onNext: () => void;
  onHome: () => void;
  onVolumeClick?: () => void;
...
export function WritingBuildSentenceQ6({ 
  onBack, 
  onNext, 
  onHome, 
  onVolumeClick,
  avatar1ImageUrl,
  avatar2ImageUrl,
  questionText = 'Have you finished your project?',
  words
}: WritingBuildSentenceQ6Props) {
  const defaultWords = ['almost', 'I', 'am', 'done', 'yes'];
