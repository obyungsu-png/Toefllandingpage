        ...
        <div className="max-w-xl mx-auto text-center px-6 w-full">
          ...
          {score && (() => {
            ...
            <div className="bg-white rounded-2xl p-6 mb-8 shadow-lg border border-gray-100">
              <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wide mb-4">Listening — 전체 점수 (2026)</h3>
              ...
              <div className={`grid ${hasM1 ? 'grid-cols-3' : 'grid-cols-1'} gap-3 mb-5`}>
                ...
                <div className="bg-gradient-to-br from-[#2d5f8a] to-[#1e4a70] rounded-xl p-4 text-center text-white shadow-md">
