...
interface WritingBuildSentenceQ3Props {
  onBack: () => void;
  onNext: () => void;
  onHome: () => void;
  onVolumeClick?: () => void;
...
export function WritingBuildSentenceQ3({ 
  onBack, 
  onNext, 
  onHome, 
  onVolumeClick,
  ...
  words
}: WritingBuildSentenceQ3Props) {
  const defaultWords = ['usually', 'I', 'friends', 'time with', 'spend', 'my'];
