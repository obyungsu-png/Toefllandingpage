...
export function ListeningM2Q3({ onBack, onNext, onHome, onVolumeClick, imageUrl, audioUrl, options, questionText }: ListeningM2Q3Props) {
      ...
      <div className="flex-1 p-4 md:p-8 overflow-auto bg-white border border-black pb-20 md:pb-8">
        <div className="w-full">
          ...
          <div className="md:hidden flex flex-col items-center">
            <ImageWithFallback 
              src={imageUrl || "listening-images/woman-green-polo.png"}
