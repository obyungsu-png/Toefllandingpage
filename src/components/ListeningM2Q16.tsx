...
export function ListeningM2Q16({ onBack, onNext, onHome, onVolumeClick, imageUrl, audioUrl, options, questionText }: ListeningM2Q16Props) {
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="md:hidden flex flex-col items-center">
            ...
            <h2 className="text-lg font-['Inter',_sans-serif] font-bold text-gray-800 mb-6 text-center px-4">
              {questionText || "What does the professor suggest that people can do to help reduce their environmental impact?"}
            </h2>
...
<div className="flex flex-row gap-16 items-start justify-center pl-12 mt-12">
              ...
              <div className="flex-1 max-w-xl mt-8">
                <h2 className="text-lg font-['Inter',_sans-serif] font-bold text-gray-800 mb-6">{questionText || "What does the professor suggest that people can do to help reduce their environmental impact?"}</h2>
