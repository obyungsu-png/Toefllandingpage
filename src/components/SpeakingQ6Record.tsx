...
export function SpeakingQ6Record({ onNext, onHome, onVolumeClick, isVolumeOpen, volumeButtonRef, imageUrl, questionText, responseDelay, stopDuration, duration, isReviewMode = false}: SpeakingQ6RecordProps) {
  ...
  return (
    <div className="fixed inset-0 bg-white z-50 flex flex-col">
      <MobileSectionHeader
        ...
        questionLabel="Question 6 of 11"
        onBack={onHome}
        onNext={onNext}
