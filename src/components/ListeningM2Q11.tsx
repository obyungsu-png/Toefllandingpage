...
export function ListeningM2Q11({ onBack, onNext, onHome, onVolumeClick, imageUrl, audioUrl, options, questionText }: ListeningM2Q11Props) {
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="md:hidden flex flex-col items-center">
            ...
            <h2 className="text-lg font-['Inter',_sans-serif] font-bold text-gray-800 mb-6 text-center px-4">
              {questionText || "What does the woman say about the history course?"}
            </h2>
...
<div className="flex flex-row gap-6 items-center justify-center pl-4 mt-4">
              ...
              <div className="flex-1 max-w-xl mt-8">
                <h2 className="text-lg font-['Inter',_sans-serif] font-bold text-gray-800 mb-6">{questionText || "What does the woman say about the history course?"}</h2>
