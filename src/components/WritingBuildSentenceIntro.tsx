...
export function WritingBuildSentenceIntro({ onBack, onNext, onHome, onVolumeClick }: WritingBuildSentenceIntroProps) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-50 z-50 flex flex-col">
      ...
      {/* Main content */}
      <div className={`flex-1 overflow-auto bg-white flex items-center justify-center ${isMobile ? 'p-4' : 'p-12'}`}>
        <div className="max-w-3xl mx-auto">
          <h1 className={`font-['Inter',_sans-serif] font-bold text-black mb-8 ${isMobile ? 'text-2xl' : 'text-4xl'}`}>Build a Sentence</h1>
