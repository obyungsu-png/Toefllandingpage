...
interface WritingBuildSentenceQ5Props {
  onBack: () => void;
  onNext: () => void;
  onHome: () => void;
  onVolumeClick?: () => void;
...
export function WritingBuildSentenceQ5({ 
  onBack, 
  onNext, 
  onHome, 
  onVolumeClick,
  avatar1ImageUrl,
  avatar2ImageUrl,
  questionText = 'Did you enjoy the conference?',
  words
}: WritingBuildSentenceQ5Props) {
  const defaultWords = ['was', 'it', 'very', 'yes', 'informative'];
