...
import speakingImage from 'figma:asset/44458442d9d5a53fc00ffa48b4fafd5ac3b715c1.png';
...
export function SpeakingQ7Prep({ onNext, onHome, onVolumeClick, isVolumeOpen, volumeButtonRef, imageUrl, questionText, audioPlayDuration, audioUrl }: SpeakingQ7PrepProps) {
