...
interface WritingBuildSentenceQ7Props {
  onBack: () => void;
  onNext: () => void;
  onHome: () => void;
  onVolumeClick?: () => void;
...
export function WritingBuildSentenceQ7({ 
  onBack, 
  onNext, 
  onHome, 
  onVolumeClick,
  avatar1ImageUrl,
  avatar2ImageUrl,
  questionText = 'Do you like your new job?',
  words
}: WritingBuildSentenceQ7Props) {
  const defaultWords = ['really', 'I', 'yes', 'it', 'enjoy'];
